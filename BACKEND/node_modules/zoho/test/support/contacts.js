...
describe('Zoho Support', function () {
  ...
  describe('Create Zoho Support records', function () {
    beforeEach(function () {
      this.params = { 'First Name': faker.name.firstName() };
      this.callback = sinon.spy();
    });

    it('should create an contact', function (done) {
      ...
      setTimeout(function () {
        ...
        created_id = response.data.Contacts.record.id;
    ...
    it('should create multiple contacts', function (done) {
      ...
      setTimeout(function () {
        ...
        response.data.Contacts.record.forEach(function (contact) {
          zohoSupport.deleteRecord(zohoModule, contact.id, function () {});
        });
    ...
    it('should fail when trying to create an contact without params', function () {
  ...
  describe('Get Zoho Support records', function () {
    ...
    it('should get an contact by id', function (done) {
    ...
    it('should fail when trying get an contact without id property', function () {
  ...
  describe('Update Zoho Support records', function () {
    ...
    it('should update an contact', function (done) {
    ...
    it('should fail when trying update an contact with id param missing', function () {
    ...
    it('should fail when trying to update an contact without params', function () {
  ...
  describe('Delete Zoho Support records', function () {
    ...
    it('should delete an contact', function (done) {
    ...
    it('should fail when trying delete an contact with id param missing', function () {
